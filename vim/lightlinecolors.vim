...
let s:p.insert.left =  [ [ s:black, s:blue ], [ s:red, s:none ], [ s:white, s:none ] ]
let s:p.replace.left = [ [ s:black, s:red ], [ s:red, s:none ], [ s:white, s:none ] ]
let s:p.visual.left =  [ [ s:black, s:orange ], [ s:red, s:none ], [ s:white, s:none ] ]
...
let s:p.inactive.left =   [ [ s:grey, s:none ] ]
let s:p.inactive.middle = [ [ s:grey, s:none ] ]
